...
var file_tracker_service_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_tracker_service_proto_goTypes = []interface{}{
	...
	nil,                      // 7: tracker.AnnounceResponse.PeersEntry
	nil,                      // 8: tracker.ScraperResponse.FilesEntry
}
var file_tracker_service_proto_depIdxs = []int32{
	7, // 0: tracker.AnnounceResponse.peers:type_name -> tracker.AnnounceResponse.PeersEntry
	8, // 1: tracker.ScraperResponse.files:type_name -> tracker.ScraperResponse.FilesEntry
	...
	1, // 6: tracker.Tracker.Publish:output_type -> tracker.PublishResponse
	3, // 7: tracker.Tracker.Announce:output_type -> tracker.AnnounceResponse
	6, // 8: tracker.Tracker.Scrape:output_type -> tracker.ScraperResponse
